...
lib.ssMetadata = [
		{name:"fsm_digital_320x50_v1_atlas_1", frames: [[236,205,112,22],[236,123,127,29],[998,57,57,21],[998,0,299,55],[0,123,234,102],[0,80,1040,41],[0,0,561,78],[563,0,433,71],[340,154,32,27],[236,154,57,49],[295,154,43,43]]}
];
...
(lib.CachedBmp_252 = function() {
	this.initialize(ss["fsm_digital_320x50_v1_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.fsm_digital_320x50_v1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:30.2,y:13.75,startPosition:29},29,cjs.Ease.quartInOut).to({rotation:14.9992,x:26.9,y:13.85,startPosition:155},126,cjs.Ease.quadInOut).to({x:16.7,y:13.75,startPosition:182},27,cjs.Ease.quartInOut).to({regX:0.1,regY:0.1,rotation:29.9984,x:16.75,y:16.95,startPosition:395},213,cjs.Ease.quadInOut).to({regX:0,regY:0,rotation:14.9992,x:3.2,y:-17.35,startPosition:431},36,cjs.Ease.quartInOut).wait(18));

	// Symbol_2
	this.instance_1 = new lib.Symbol2("synched",0);
	this.instance_1.setTransform(305.85,-14.55);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:291.15,y:19.05,startPosition:29},29,cjs.Ease.quartInOut).to({rotation:14.9992,y:15.55,startPosition:155},126,cjs.Ease.quadInOut).to({x:306.35,y:16.25,startPosition:182},27,cjs.Ease.quartInOut).to({regX:0.1,regY:-0.1,rotation:44.9988,x:306.45,y:21.5,startPosition:395},213,cjs.Ease.quadInOut).to({regX:0,regY:0,rotation:14.9992,x:336.8,y:-0.95,startPosition:431},36,cjs.Ease.quartInOut).wait(18));

	// Symbol_3
	this.instance_2 = new lib.Symbol3("synched",0);
	this.instance_2.setTransform(82.5,67.65);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:87.4,y:48,startPosition:29},29,cjs.Ease.quartInOut).to({rotation:-14.9992,x:85.35,y:50.85,startPosition:155},126,cjs.Ease.quadInOut).to({rotation:0,x:87.4,y:63.15,startPosition:182},27,cjs.Ease.quartInOut).to({startPosition:395},213,cjs.Ease.quadInOut).to({startPosition:431},36,cjs.Ease.quartInOut).wait(18));

	// Symbol_4
	this.instance_3 = new lib.Symbol4("synched",0);
	this.instance_3.setTransform(210.3,63.45);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:201.3,y:41.75,startPosition:29},29,cjs.Ease.quartInOut).to({rotation:14.9992,startPosition:155},126,cjs.Ease.quadInOut).to({rotation:0,y:64.3,startPosition:182},27,cjs.Ease.quartInOut).to({startPosition:395},213,cjs.Ease.quadInOut).to({startPosition:431},36,cjs.Ease.quartInOut).wait(18));

	// Symbol_5
	this.instance_4 = new lib.Symbol5("synched",0);
	this.instance_4.setTransform(331.45,54.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:320,y:45.9,startPosition:29},29,cjs.Ease.quartInOut).to({rotation:7.4814,x:319.5,y:53.3,startPosition:155},126,cjs.Ease.quadInOut).to({rotation:14.9992,x:314.7,y:62.3,startPosition:182},27,cjs.Ease.quartInOut).to({regX:0.1,regY:0.1,rotation:29.9984,x:314.8,y:63.4,startPosition:395},213,cjs.Ease.quadInOut).to({regX:0,regY:0,rotation:14.9992,x:325.75,y:71.15,startPosition:431},36,cjs.Ease.quartInOut).wait(18));

	// Symbol_6
	this.instance_5 = new lib.Symbol6("synched",0);
	this.instance_5.setTransform(-8.3,56.25);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:5.6,y:42.7,startPosition:29},29,cjs.Ease.quartInOut).to({rotation:-4.7062,x:10.1,y:48.45,startPosition:155},126,cjs.Ease.quadInOut).to({rotation:0,x:-3.4,y:49.3,startPosition:182},27,cjs.Ease.quartInOut).to({x:8.85,y:55.85,startPosition:395},213,cjs.Ease.quadInOut).to({x:-28.75,y:67.3,startPosition:431},36,cjs.Ease.quartInOut).wait(18));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(175).to({_off:false},0).wait(1).to({regX:-0.7,x:159.35,y:14.35,alpha:0.4491},0).wait(1).to({y:17.25,alpha:0.6049},0).wait(1).to({y:19.2,alpha:0.7092},0).wait(1).to({y:20.65,alpha:0.7863},0).wait(1).to({y:21.8,alpha:0.8454},0).wait(1).to({y:22.7,alpha:0.8917},0).wait(1).to({y:23.45,alpha:0.9276},0).wait(1).to({y:24,alpha:0.9551},0).wait(1).to({y:24.4,alpha:0.9753},0).wait(1).to({y:24.7,alpha:0.9893},0).wait(1).to({y:24.85,alpha:0.9973},0).wait(1).to({y:24.95,alpha:1},0).wait(1).to({regX:0,x:160.05},0).wait(202).to({startPosition:0},0).wait(1).to({regX:-0.7,x:159.35,y:24.9,alpha:0.9982},0).wait(1).to({y:24.8,alpha:0.9923},0).wait(1).to({y:24.7,alpha:0.9816},0).wait(1).to({y:24.45,alpha:0.9652},0).wait(1).to({y:24.2,alpha:0.9419},0).wait(1).to({y:23.75,alpha:0.9101},0).wait(1).to({y:23.25,alpha:0.8676},0).wait(1).to({y:22.55,alpha:0.8113},0).wait(1).to({y:21.65,alpha:0.7365},0).wait(1).to({y:20.5,alpha:0.6361},0).wait(1).to({y:18.9,alpha:0.4978},0).wait(1).to({y:16.75,alpha:0.2998},0).wait(1).to({y:13.5,alpha:0},0).to({_off:true},1).wait(45));

	// t1
	this.instance_12 = new lib.t1("synched",0);
	this.instance_12.setTransform(160.95,26.95);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(149).to({startPosition:0},0).wait(1).to({regX:-0.1,regY:0.1,x:160.85,y:27,alpha:0.9982},0).wait(1).to({y:26.9,alpha:0.9923},0).wait(1).to({y:26.8,alpha:0.9816},0).wait(1).to({y:26.55,alpha:0.9652},0).wait(1).to({y:26.3,alpha:0.9419},0).wait(1).to({y:25.85,alpha:0.9101},0).wait(1).to({y:25.35,alpha:0.8676},0).wait(1).to({y:24.65,alpha:0.8113},0).wait(1).to({y:23.75,alpha:0.7365},0).wait(1).to({y:22.6,alpha:0.6361},0).wait(1).to({y:21,alpha:0.4978},0).wait(1).to({y:18.85,alpha:0.2998},0).wait(1).to({y:15.6,alpha:0},0).to({_off:true},1).wait(286));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/fsm_digital_320x50_v1_atlas_1.png", id:"fsm_digital_320x50_v1_atlas_1"}
	],
	preloads: []
};
