...
lib.ssMetadata = [
		{name:"fsm_digital_300x600_v1_atlas_1", frames: [[1232,183,198,39],[875,390,224,51],[1932,94,100,38],[651,390,222,70],[1450,183,529,97],[1101,390,132,74],[0,390,649,127],[1232,0,504,181],[583,0,647,241],[0,0,581,376],[1923,282,117,99],[1450,282,171,220],[1932,0,91,92],[1765,282,156,122],[1738,0,192,166],[1923,383,115,90],[1623,282,140,139],[583,243,865,145]]}
];
...
(lib.CachedBmp_136 = function() {
	this.initialize(ss["fsm_digital_300x600_v1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(142).to({_off:true},1).wait(30).to({_off:false},0).wait(104).to({_off:true},1).wait(22).to({_off:false},0).wait(119).to({_off:true},1).wait(1).to({_off:false},0).wait(28));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(142).to({_off:true},1).wait(30).to({_off:false},0).wait(104).to({_off:true},1).wait(22).to({_off:false},0).wait(119).to({_off:true},1).wait(1).to({_off:false},0).wait(28));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_1},{t:this.shape}]},142).to({state:[]},1).to({state:[{t:this.shape_1},{t:this.shape}]},30).to({state:[{t:this.shape_1},{t:this.shape}]},104).to({state:[]},1).to({state:[{t:this.shape_1},{t:this.shape}]},22).to({state:[{t:this.shape_1},{t:this.shape}]},119).to({state:[]},1).to({state:[{t:this.shape_1},{t:this.shape}]},1).wait(28));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).to({state:[{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]},142).to({state:[]},1).to({state:[{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]},30).to({state:[{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]},104).to({state:[]},1).to({state:[{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]},22).to({state:[{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]},119).to({state:[]},1).to({state:[{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]},1).wait(28));
...
// stage content:
(lib.fsm_digital_300x600_v1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:-5.9557,x:277.85,y:7.35,startPosition:28},28,cjs.Ease.quartInOut).to({rotation:-20.2425,x:275.05,y:9.45,startPosition:73},98,cjs.Ease.quadInOut).to({rotation:0,x:279.05,y:12.7,startPosition:173},70,cjs.Ease.quartInOut).to({rotation:-14.9992,x:281.25,y:21.15,startPosition:300},105,cjs.Ease.quadInOut).to({x:276.05,y:18.65,startPosition:421},120,cjs.Ease.quadInOut).wait(28));

	// Symbol_2
	this.instance_1 = new lib.Symbol2("synched",0);
	this.instance_1.setTransform(219.95,-44.15);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({rotation:-2.4102,x:199,y:31.65,startPosition:28},28,cjs.Ease.quartInOut).to({rotation:-8.1935,x:199.7,y:35.15,startPosition:73},98,cjs.Ease.quadInOut).to({rotation:0,x:198.7,y:49.15,startPosition:173},70,cjs.Ease.quartInOut).to({rotation:14.9992,x:207.05,startPosition:300},105,cjs.Ease.quadInOut).to({x:201.7,y:50.15,startPosition:421},120,cjs.Ease.quadInOut).wait(28));

	// Symbol_3
	this.instance_2 = new lib.Symbol3("synched",0);
	this.instance_2.setTransform(340.4,156.05);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({rotation:4.4125,x:212.35,y:158.1,startPosition:28},28,cjs.Ease.quartInOut).to({rotation:14.9992,x:209.5,y:163.05,startPosition:73},98,cjs.Ease.quadInOut).to({rotation:0,x:213.5,y:180.05,startPosition:173},70,cjs.Ease.quartInOut).to({startPosition:300},105,cjs.Ease.quadInOut).to({rotation:14.9992,x:217.5,y:183.05,startPosition:421},120,cjs.Ease.quadInOut).wait(28));

	// Symbol_4
	this.instance_3 = new lib.Symbol4("synched",0);
	this.instance_3.setTransform(372.5,517.15);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({rotation:4.4125,x:217.55,y:479.3,startPosition:28},28,cjs.Ease.quartInOut).to({rotation:14.9992,y:477.15,startPosition:73},98,cjs.Ease.quadInOut).to({rotation:0,x:217.85,y:415.15,startPosition:173},70,cjs.Ease.quartInOut).to({rotation:-14.9992,y:411.25,startPosition:300},105,cjs.Ease.quadInOut).to({rotation:0,x:215.85,y:428.15,startPosition:421},120,cjs.Ease.quadInOut).wait(28));

	// Symbol_5
	this.instance_4 = new lib.Symbol5("synched",0);
	this.instance_4.setTransform(81.75,636.25);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({rotation:-4.4125,x:102.8,y:522,startPosition:28},28,cjs.Ease.quartInOut).to({rotation:-14.9992,x:107.75,y:521.3,startPosition:73},98,cjs.Ease.quadInOut).to({x:124.7,y:481.3,startPosition:173},70,cjs.Ease.quartInOut).to({regY:0.1,rotation:-14.9994,x:118.25,y:479.65,startPosition:300},105,cjs.Ease.quadInOut).to({regY:0,rotation:-14.9992,x:133.7,y:488.3,startPosition:421},120,cjs.Ease.quadInOut).wait(28));

	// Symbol_6
	this.instance_5 = new lib.Symbol6("synched",0);
	this.instance_5.setTransform(-45.15,209.55);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:29.8,y:219.45,startPosition:28},28,cjs.Ease.quartInOut).to({regX:0.1,startPosition:73},98,cjs.Ease.quadInOut).to({regX:0,x:46.3,y:210.3,startPosition:173},70,cjs.Ease.quartInOut).to({rotation:-14.9992,startPosition:300},105,cjs.Ease.quadInOut).to({rotation:14.9992,x:46.25,y:208.3,startPosition:421},120,cjs.Ease.quadInOut).wait(28));

	// Symbol_7
	this.instance_6 = new lib.Symbol7("synched",0);
	this.instance_6.setTransform(-35.7,85.25);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({rotation:4.4125,x:106.1,y:126.25,startPosition:28},28,cjs.Ease.quartInOut).to({rotation:14.9992,x:111.05,y:129.05,startPosition:73},98,cjs.Ease.quadInOut).to({rotation:0,x:135.3,y:147.85,startPosition:173},70,cjs.Ease.quartInOut).to({rotation:-14.9992,x:132.3,startPosition:300},105,cjs.Ease.quadInOut).to({x:130.3,y:142.85,startPosition:421},120,cjs.Ease.quadInOut).wait(28));

	// Symbol_8
	this.instance_7 = new lib.Symbol8("synched",0);
	this.instance_7.setTransform(-36.4,135.95);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({rotation:-4.4125,x:25.95,y:113.75,startPosition:28},28,cjs.Ease.quartInOut).to({rotation:-14.9992,x:27.35,y:117.95,startPosition:73},98,cjs.Ease.quadInOut).to({rotation:-8.4763,x:30.9,y:102.05,startPosition:173},70,cjs.Ease.quartInOut).to({x:34.85,startPosition:300},105,cjs.Ease.quadInOut).to({rotation:6.5222,x:27.65,y:90.05,startPosition:421},120,cjs.Ease.quadInOut).wait(28));

	// Symbol_9
	this.instance_8 = new lib.Symbol9("synched",0);
	this.instance_8.setTransform(-58.95,456.25);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({rotation:2.0515,x:40.8,y:442.05,startPosition:28},28,cjs.Ease.quartInOut).to({rotation:6.9746,x:43.55,y:444.15,startPosition:73},98,cjs.Ease.quadInOut).to({rotation:0,x:66.55,y:402.5,startPosition:173},70,cjs.Ease.quartInOut).to({rotation:14.9992,x:85.5,startPosition:300},105,cjs.Ease.quadInOut).to({x:66.5,y:408.5,startPosition:421},120,cjs.Ease.quadInOut).wait(28));

	// Symbol_10
	this.instance_9 = new lib.Symbol10("synched",0);
	this.instance_9.setTransform(6.3,605.75);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({rotation:-1.9745,x:21.9,y:580.6,startPosition:28},28,cjs.Ease.quartInOut).to({rotation:-6.7104,y:582,startPosition:73},98,cjs.Ease.quadInOut).to({regY:0.1,rotation:83.6951,x:-30.9,y:515,startPosition:173},70,cjs.Ease.quartInOut).to({rotation:90.4127,x:-30,y:505,startPosition:300},105,cjs.Ease.quadInOut).to({regX:-0.1,rotation:98.6939,x:-16.9,y:499.95,startPosition:421},120,cjs.Ease.quadInOut).wait(28));

	// Symbol_11
	this.instance_10 = new lib.Symbol11("synched",0);
	this.instance_10.setTransform(-26.95,371.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({rotation:2.0497,x:0.25,y:371.8,startPosition:28},28,cjs.Ease.quartInOut).to({rotation:6.9676,x:1,y:372.5,startPosition:73},98,cjs.Ease.quadInOut).to({rotation:14.9992,x:-16.95,y:371.5,startPosition:173},70,cjs.Ease.quartInOut).to({rotation:29.9977,y:377.5,startPosition:300},105,cjs.Ease.quadInOut).to({rotation:14.9992,x:-15.75,y:357.1,startPosition:421},120,cjs.Ease.quadInOut).wait(28));

	// Symbol_12
	this.instance_11 = new lib.Symbol12("synched",0);
	this.instance_11.setTransform(-34,64.05);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({rotation:-4.4125,x:3.9,y:69.15,startPosition:28},28,cjs.Ease.quartInOut).to({rotation:-14.9992,x:6,y:67.75,startPosition:73},98,cjs.Ease.quadInOut).to({rotation:-8.4763,x:1,y:85.1,startPosition:173},70,cjs.Ease.quartInOut).to({rotation:6.5222,x:0.95,y:103.1,startPosition:300},105,cjs.Ease.quadInOut).to({x:3.7,y:71.1,startPosition:421},120,cjs.Ease.quadInOut).wait(28));

	// Symbol_13
	this.instance_12 = new lib.Symbol13("synched",0);
	this.instance_12.setTransform(333.9,602);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({x:291.35,y:570.6,startPosition:28},28,cjs.Ease.quartInOut).to({x:294.9,y:567.05,startPosition:73},98,cjs.Ease.quadInOut).to({x:326.2,y:465.2,startPosition:173},70,cjs.Ease.quartInOut).to({rotation:-5.9663,x:334.55,startPosition:300},105,cjs.Ease.quadInOut).to({rotation:-9.2045,x:329.75,y:461.2,startPosition:421},120,cjs.Ease.quadInOut).wait(28));

	// Symbol_14
	this.instance_13 = new lib.Symbol14("synched",0);
	this.instance_13.setTransform(344.85,129.75);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({rotation:-1.9019,x:290.5,y:146.15,startPosition:28},28,cjs.Ease.quartInOut).to({rotation:-6.4658,x:291.9,y:148.25,startPosition:73},98,cjs.Ease.quadInOut).to({rotation:0,x:289.9,y:163,startPosition:173},70,cjs.Ease.quartInOut).to({rotation:14.9992,startPosition:300},105,cjs.Ease.quadInOut).to({rotation:-8.9672,x:295.9,y:157,startPosition:421},120,cjs.Ease.quadInOut).wait(28));

	// Symbol_15
	this.instance_14 = new lib.Symbol15("synched",0);
	this.instance_14.setTransform(57.7,-45.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({rotation:-1.608,x:59.85,y:-20.65,startPosition:28},28,cjs.Ease.quartInOut).to({rotation:-5.4654,x:57.7,y:-17.85,startPosition:73},98,cjs.Ease.quadInOut).to({rotation:8.7513,x:63.7,startPosition:173},70,cjs.Ease.quartInOut).to({regX:0.1,regY:-0.1,rotation:1.7987,x:71.85,y:-0.1,startPosition:300},105,cjs.Ease.quadInOut).to({regY:0,rotation:3.2584,x:74.8,y:-14.85,startPosition:421},120,cjs.Ease.quadInOut).wait(28));

	// t3_bars
	this.instance_15 = new lib.t3bars("synched",0);
	this.instance_15.setTransform(149.05,263.35);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(423).to({_off:false},0).wait(1).to({y:270.8287,alpha:0.4491},0).wait(1).to({y:273.7002,alpha:0.6049},0).wait(1).to({y:275.6601,alpha:0.7092},0).wait(1).to({y:277.1327,alpha:0.7863},0).wait(1).to({y:278.2804,alpha:0.8454},0).wait(1).to({y:279.1889,alpha:0.8917},0).wait(1).to({y:279.9064,alpha:0.9276},0).wait(1).to({y:280.4644,alpha:0.9551},0).wait(1).to({y:280.8811,alpha:0.9753},0).wait(1).to({y:281.1714,alpha:0.9893},0).wait(1).to({y:281.3428,alpha:0.9973},0).wait(1).to({y:281.4,alpha:1},0).wait(1).to({startPosition:0},0).wait(13));

	// t3_meals
	this.instance_16 = new lib.t3meals("synched",0);
	this.instance_16.setTransform(225.15,264.1);
	this.instance_16.alpha = 0;
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(426).to({_off:false},0).wait(1).to({y:271.5787,alpha:0.4491},0).wait(1).to({y:274.4502,alpha:0.6049},0).wait(1).to({y:276.4101,alpha:0.7092},0).wait(1).to({y:277.8827,alpha:0.7863},0).wait(1).to({y:279.0304,alpha:0.8454},0).wait(1).to({y:279.9389,alpha:0.8917},0).wait(1).to({y:280.6564,alpha:0.9276},0).wait(1).to({y:281.2144,alpha:0.9551},0).wait(1).to({y:281.6311,alpha:0.9753},0).wait(1).to({y:281.9214,alpha:0.9893},0).wait(1).to({y:282.0928,alpha:0.9973},0).wait(1).to({y:282.15,alpha:1},0).wait(1).to({startPosition:0},0).wait(10));

	// t3_summer
	this.instance_17 = new lib.t3summer("synched",0);
	this.instance_17.setTransform(118,261.85);
	this.instance_17.alpha = 0;
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(429).to({_off:false},0).wait(1).to({regX:0.1,regY:0.1,x:118.1,y:269.4,alpha:0.4491},0).wait(1).to({y:272.3,alpha:0.6049},0).wait(1).to({y:274.25,alpha:0.7092},0).wait(1).to({y:275.7,alpha:0.7863},0).wait(1).to({y:276.85,alpha:0.8454},0).wait(1).to({y:277.75,alpha:0.8917},0).wait(1).to({y:278.5,alpha:0.9276},0).wait(1).to({y:279.05,alpha:0.9551},0).wait(1).to({y:279.45,alpha:0.9753},0).wait(1).to({y:279.75,alpha:0.9893},0).wait(1).to({y:279.9,alpha:0.9973},0).wait(1).to({y:280,alpha:1},0).wait(1).to({regX:0,regY:0,x:118,y:279.9},0).wait(7));

	// t3_free
	this.instance_18 = new lib.t3free("synched",0);
	this.instance_18.setTransform(42.55,262);
	this.instance_18.alpha = 0;
	this.instance_18._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(431).to({_off:false},0).wait(1).to({y:269.4787,alpha:0.4491},0).wait(1).to({y:272.3502,alpha:0.6049},0).wait(1).to({y:274.3101,alpha:0.7092},0).wait(1).to({y:275.7827,alpha:0.7863},0).wait(1).to({y:276.9304,alpha:0.8454},0).wait(1).to({y:277.8389,alpha:0.8917},0).wait(1).to({y:278.5564,alpha:0.9276},0).wait(1).to({y:279.1144,alpha:0.9551},0).wait(1).to({y:279.5311,alpha:0.9753},0).wait(1).to({y:279.8214,alpha:0.9893},0).wait(1).to({y:279.9928,alpha:0.9973},0).wait(1).to({y:280.05,alpha:1},0).wait(1).to({startPosition:0},0).wait(5));

	// t3_button
	this.instance_19 = new lib.t3button("synched",0);
	this.instance_19.setTransform(150,330.15);
	this.instance_19.alpha = 0;
	this.instance_19._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(433).to({_off:false},0).wait(1).to({y:337.6287,alpha:0.4491},0).wait(1).to({y:340.5002,alpha:0.6049},0).wait(1).to({y:342.4601,alpha:0.7092},0).wait(1).to({y:343.9327,alpha:0.7863},0).wait(1).to({y:345.0804,alpha:0.8454},0).wait(1).to({y:345.9889,alpha:0.8917},0).wait(1).to({y:346.7064,alpha:0.9276},0).wait(1).to({y:347.2644,alpha:0.9551},0).wait(1).to({y:347.6811,alpha:0.9753},0).wait(1).to({y:347.9714,alpha:0.9893},0).wait(1).to({y:348.1428,alpha:0.9973},0).wait(1).to({y:348.2,alpha:1},0).wait(1).to({startPosition:0},0).wait(3));

	// t2_logos
	this.instance_20 = new lib.t2logos("synched",0);
	this.instance_20.setTransform(152.65,631.7);
	this.instance_20.alpha = 0;
	this.instance_20._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(194).to({_off:false},0).wait(1).to({x:152.6375,y:605.1827,alpha:0.4491},0).wait(1).to({x:152.625,y:595.0013,alpha:0.6049},0).wait(1).to({x:152.6125,y:588.052,alpha:0.7092},0).wait(1).to({x:152.6,y:582.8307,alpha:0.7863},0).wait(1).to({x:152.5875,y:578.7613,alpha:0.8454},0).wait(1).to({x:152.575,y:575.54,alpha:0.8917},0).wait(1).to({x:152.5625,y:572.996,alpha:0.9276},0).wait(1).to({x:152.55,y:571.0173,alpha:0.9551},0).wait(1).to({x:152.5375,y:569.54,alpha:0.9753},0).wait(1).to({x:152.525,y:568.5107,alpha:0.9893},0).wait(1).to({x:152.5125,y:567.9027,alpha:0.9973},0).wait(1).to({x:152.5,y:567.7,alpha:1},0).wait(1).to({startPosition:0},0).wait(242));

	// t2_
	this.instance_21 = new lib.t2("synched",0);
	this.instance_21.setTransform(153.1,275.25);
	this.instance_21.alpha = 0;
	this.instance_21._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(178).to({_off:false},0).wait(1).to({regY:0.1,y:282.8,alpha:0.4491},0).wait(1).to({y:285.7,alpha:0.6049},0).wait(1).to({y:287.65,alpha:0.7092},0).wait(1).to({y:289.1,alpha:0.7863},0).wait(1).to({y:290.25,alpha:0.8454},0).wait(1).to({y:291.15,alpha:0.8917},0).wait(1).to({y:291.9,alpha:0.9276},0).wait(1).to({y:292.45,alpha:0.9551},0).wait(1).to({y:292.85,alpha:0.9753},0).wait(1).to({y:293.15,alpha:0.9893},0).wait(1).to({y:293.3,alpha:0.9973},0).wait(1).to({y:293.4,alpha:1},0).wait(1).to({regY:0,y:293.3},0).wait(217).to({startPosition:0},0).wait(1).to({regY:0.1,y:293.35,alpha:0.9982},0).wait(1).to({y:293.25,alpha:0.9923},0).wait(1).to({y:293.15,alpha:0.9816},0).wait(1).to({y:292.9,alpha:0.9652},0).wait(1).to({y:292.65,alpha:0.9419},0).wait(1).to({y:292.2,alpha:0.9101},0).wait(1).to({y:291.7,alpha:0.8676},0).wait(1).to({y:291,alpha:0.8113},0).wait(1).to({y:290.1,alpha:0.7365},0).wait(1).to({y:288.95,alpha:0.6361},0).wait(1).to({y:287.35,alpha:0.4978},0).wait(1).to({y:285.2,alpha:0.2998},0).wait(1).to({y:281.95,alpha:0},0).to({_off:true},1).wait(27));

	// t1
	this.instance_22 = new lib.t1("synched",0);
	this.instance_22.setTransform(147.05,304.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(149).to({startPosition:0},0).wait(1).to({y:304.8762,alpha:0.9982},0).wait(1).to({y:304.7987,alpha:0.9923},0).wait(1).to({y:304.6596,alpha:0.9816},0).wait(1).to({y:304.4482,alpha:0.9652},0).wait(1).to({y:304.1505,alpha:0.9419},0).wait(1).to({y:303.7488,alpha:0.9101},0).wait(1).to({y:303.2195,alpha:0.8676},0).wait(1).to({y:302.5307,alpha:0.8113},0).wait(1).to({y:301.635,alpha:0.7365},0).wait(1).to({y:300.4618,alpha:0.6361},0).wait(1).to({y:298.8958,alpha:0.4978},0).wait(1).to({y:296.7212,alpha:0.2998},0).wait(1).to({y:293.45,alpha:0},0).to({_off:true},1).wait(286));
...
p.nominalBounds = new cjs.Rectangle(61.8,197.6,364.5,491.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/fsm_digital_300x600_v1_atlas_1.png", id:"fsm_digital_300x600_v1_atlas_1"}
	],
	preloads: []
};
