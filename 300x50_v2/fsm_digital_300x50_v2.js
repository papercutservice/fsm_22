...
lib.ssMetadata = [
		{name:"fsm_digital_300x50_v2_atlas_1", frames: [[0,0,1040,93],[1847,102,108,21],[1847,72,122,28],[1847,125,55,21],[1042,80,289,53],[1605,72,240,102],[0,95,1040,41],[1042,0,561,78],[1605,0,433,70],[2002,123,32,27],[1971,72,57,49],[1957,123,43,42]]}
];
...
(lib.CachedBmp_143 = function() {
	this.initialize(ss["fsm_digital_300x50_v2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(140).to({_off:true},1).wait(18).to({_off:false},0).wait(122).to({_off:true},1).wait(111).to({_off:false},0).wait(56));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(140).to({_off:true},1).wait(18).to({_off:false},0).wait(122).to({_off:true},1).wait(111).to({_off:false},0).wait(56));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]},140).to({state:[]},1).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]},18).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]},122).to({state:[]},1).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]},111).wait(56));
...
// stage content:
(lib.fsm_digital_300x50_v2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({startPosition:0},141,cjs.Ease.quartInOut).to({x:20.75,y:16.6,startPosition:29},20,cjs.Ease.quartInOut).to({rotation:14.9992,x:17.05,y:16.5,startPosition:159},109,cjs.Ease.quadInOut).to({x:6.4,y:16.6,startPosition:188},29,cjs.Ease.quartInOut).to({regX:0.1,regY:0.1,rotation:29.9984,x:10.95,y:9.55,startPosition:393},94,cjs.Ease.quadInOut).to({regX:0,regY:0,rotation:14.9992,x:-21.4,y:-10,startPosition:431},38,cjs.Ease.quartInOut).wait(18));

	// Symbol_2
	this.instance_1 = new lib.Symbol2("synched",0);
	this.instance_1.setTransform(290.45,-16.55);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({startPosition:0},141,cjs.Ease.quartInOut).to({x:281.4,y:15.4,startPosition:29},20,cjs.Ease.quartInOut).to({rotation:-14.9992,x:279.35,y:15.65,startPosition:159},109,cjs.Ease.quadInOut).to({x:290.55,y:8.1,startPosition:188},29,cjs.Ease.quartInOut).to({regX:0.1,regY:0.1,rotation:-29.9984,x:291.45,y:14.1,startPosition:393},94,cjs.Ease.quadInOut).to({regX:0,regY:0,rotation:-14.9992,x:320.95,y:-2.8,startPosition:431},38,cjs.Ease.quartInOut).wait(18));

	// Symbol_3
	this.instance_2 = new lib.Symbol3("synched",0);
	this.instance_2.setTransform(77.55,57.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({startPosition:0},141,cjs.Ease.quartInOut).to({y:45,startPosition:29},20,cjs.Ease.quartInOut).to({x:82.85,y:49.75,startPosition:159},109,cjs.Ease.quadInOut).to({x:73.5,y:64.45,startPosition:188},29,cjs.Ease.quartInOut).to({startPosition:393},94,cjs.Ease.quadInOut).to({startPosition:431},38,cjs.Ease.quartInOut).wait(18));

	// Symbol_4
	this.instance_3 = new lib.Symbol4("synched",0);
	this.instance_3.setTransform(183.25,63.55);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({startPosition:0},141,cjs.Ease.quartInOut).to({x:191.45,y:41.4,startPosition:29},20,cjs.Ease.quartInOut).to({rotation:-14.9992,x:198.85,y:41.35,startPosition:159},109,cjs.Ease.quadInOut).to({rotation:0,x:191.45,y:60.25,startPosition:188},29,cjs.Ease.quartInOut).to({startPosition:393},94,cjs.Ease.quadInOut).to({startPosition:431},38,cjs.Ease.quartInOut).wait(18));

	// Symbol_5
	this.instance_4 = new lib.Symbol5("synched",0);
	this.instance_4.setTransform(293.8,59);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({rotation:-5.4751,x:291.7},141,cjs.Ease.quartInOut).to({rotation:0,x:283.25,y:53.2,startPosition:29},20,cjs.Ease.quartInOut).to({rotation:-6.4746,x:288.15,y:53.8,startPosition:159},109,cjs.Ease.quadInOut).to({rotation:-5.9663,x:290.6,y:56.7,startPosition:188},29,cjs.Ease.quartInOut).to({rotation:1.4751,x:284.5,y:56.65,startPosition:393},94,cjs.Ease.quadInOut).to({rotation:-50.9654,x:329.95,y:32.4,startPosition:431},38,cjs.Ease.quartInOut).wait(18));

	// Symbol_6
	this.instance_5 = new lib.Symbol6("synched",0);
	this.instance_5.setTransform(-17.95,51.55);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regY:0.1,rotation:22.4232,x:-16.1,y:40.4},141,cjs.Ease.quartInOut).to({regY:0,rotation:0,x:-9.3,y:46.45,startPosition:29},20,cjs.Ease.quartInOut).to({rotation:-5.447,x:-2.25,y:49.75,startPosition:159},109,cjs.Ease.quadInOut).to({rotation:14.9992,x:-16.75,y:48.4,startPosition:188},29,cjs.Ease.quartInOut).to({rotation:9.787,x:-4.5,y:52.5,startPosition:393},94,cjs.Ease.quadInOut).to({rotation:59.998,x:-31.15,y:24.8,startPosition:431},38,cjs.Ease.quartInOut).wait(18));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(277).to({_off:false},0).wait(1).to({regX:0.6,x:150.6,y:14.4,alpha:0.4491},0).wait(1).to({y:17.3,alpha:0.6049},0).wait(1).to({y:19.25,alpha:0.7092},0).wait(1).to({y:20.7,alpha:0.7863},0).wait(1).to({y:21.85,alpha:0.8454},0).wait(1).to({y:22.75,alpha:0.8917},0).wait(1).to({y:23.5,alpha:0.9276},0).wait(1).to({y:24.05,alpha:0.9551},0).wait(1).to({y:24.45,alpha:0.9753},0).wait(1).to({y:24.75,alpha:0.9893},0).wait(1).to({y:24.9,alpha:0.9973},0).wait(1).to({y:25,alpha:1},0).wait(1).to({regX:0,x:150},0).wait(113).to({startPosition:0},0).wait(1).to({regX:0.6,x:150.6,y:24.95,alpha:0.9982},0).wait(1).to({y:24.85,alpha:0.9923},0).wait(1).to({y:24.75,alpha:0.9816},0).wait(1).to({y:24.5,alpha:0.9652},0).wait(1).to({y:24.25,alpha:0.9419},0).wait(1).to({y:23.8,alpha:0.9101},0).wait(1).to({y:23.3,alpha:0.8676},0).wait(1).to({y:22.6,alpha:0.8113},0).wait(1).to({y:21.7,alpha:0.7365},0).wait(1).to({y:20.55,alpha:0.6361},0).wait(1).to({y:18.95,alpha:0.4978},0).wait(1).to({y:16.8,alpha:0.2998},0).wait(1).to({y:13.55,alpha:0},0).to({_off:true},1).wait(32));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(142).to({_off:false},0).wait(1).to({alpha:0.0769},0).wait(1).to({alpha:0.1538},0).wait(1).to({alpha:0.2308},0).wait(1).to({alpha:0.3077},0).wait(1).to({alpha:0.3846},0).wait(1).to({alpha:0.4615},0).wait(1).to({alpha:0.5385},0).wait(1).to({alpha:0.6154},0).wait(1).to({alpha:0.6923},0).wait(1).to({alpha:0.7692},0).wait(1).to({alpha:0.8462},0).wait(1).to({alpha:0.9231},0).wait(1).to({alpha:1},0).wait(1).to({startPosition:0},0).wait(106).to({startPosition:0},0).wait(1).to({y:26.5762,alpha:0.9982},0).wait(1).to({y:26.4987,alpha:0.9923},0).wait(1).to({y:26.3596,alpha:0.9816},0).wait(1).to({y:26.1482,alpha:0.9652},0).wait(1).to({y:25.8505,alpha:0.9419},0).wait(1).to({y:25.4488,alpha:0.9101},0).wait(1).to({y:24.9195,alpha:0.8676},0).wait(1).to({y:24.2307,alpha:0.8113},0).wait(1).to({y:23.335,alpha:0.7365},0).wait(1).to({y:22.1618,alpha:0.6361},0).wait(1).to({y:20.5958,alpha:0.4978},0).wait(1).to({y:18.4212,alpha:0.2998},0).wait(1).to({y:15.15,alpha:0},0).to({_off:true},1).wait(173));

	// Layer_1
	this.instance_13 = new lib.txt_save_horizontal("synched",0);
	this.instance_13.setTransform(150.8,24.55,0.5267,0.5267,0,0,0,-17.8,4.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(131).to({startPosition:0},0).to({alpha:0},10,cjs.Ease.cubicInOut).to({_off:true},1).wait(307));
...
p.nominalBounds = new cjs.Rectangle(40.6,-3.8,370,90);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/fsm_digital_300x50_v2_atlas_1.png", id:"fsm_digital_300x50_v2_atlas_1"}
	],
	preloads: []
};
